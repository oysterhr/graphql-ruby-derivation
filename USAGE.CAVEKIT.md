...
| `GraphQL::Derivation::Rails::ArgumentCoercionError` | Request-time coercion failure (missing required arg, bad type, bad enum value) — only error here **not** a `ConfigurationError`. |
